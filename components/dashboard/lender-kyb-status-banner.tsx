...
const statusConfig = {
  not_started: {
    ...
    description: "You need to complete KYB (Know Your Business) verification before you can start investing.",
    bgColor: "bg-amber-50",
  ...
  under_review: {
    ...
    description: "Our team is currently reviewing your documents. You'll be notified once the review is complete.",
    bgColor: "bg-blue-50",
    borderColor: "border-blue-200",
    iconColor: "text-blue-500",
    showCta: false,
  ...
  approved: {
    ...
    description: "Your identity has been verified. You can now start investing in projects.",
    bgColor: "bg-green-50",
